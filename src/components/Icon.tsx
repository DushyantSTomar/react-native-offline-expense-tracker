...
export type IconName = 'food' | 'transport' | 'shopping' | 'bills' | 'health' | 'entertainment' | 'other' | 'arrow-left' | 'plus' | 'chart' | 'home' | 'trash' | 'calendar' | 'filter' | 'close';
...
const icons: Record<IconName, string> = {
    ...
    entertainment: "M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5c0-1.1-.9-2-2-2zm0 14H3V5h18v12z",
    other: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z",
